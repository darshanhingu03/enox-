...
const Hero = () => {
  ...
  const nextImg = (n) => {
    ...
    setImgNav(show);
    setActiveModalImage(galleryArray[1]);
  };
  ...
  return (
    <main>
      ...
      <div className="description">
        <div className="info">
          <p className="company">ENOX LUBRICANT</p>
          <h1 style={{ marginBottom: "0.2rem" }}>PRIME PRO</h1>
          <h3>Fully Synthetic Car Engine Oil (5W-30)</h3>
          <p className="item-info">
            PRIMEPRO Made From Fully Synthetic base stock With multi-functional
            additives. It’s designed to provide highly responsive protection
            that continuously adapts to your driving conditions. The use of
            selected low-viscosity synthetic base stock further energizes the
            oil’s protective capability that promotes fuel economy performance
            with no compromise in durability. PRIMEPRO 5W-30 meets the API
            specifications in that it has improved sludge handling performance
            to further increase it’s the long drain capabilities. It comes as
